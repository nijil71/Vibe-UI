...
export function InfraSection() {
    return (
        <div className="w-full max-w-7xl mx-auto py-16 md:py-24 px-6">
            ...
            <div className="mt-16 md:mt-20 p-8 md:p-12 rounded-3xl bg-blue-600/5 border border-accent-blue/20 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden text-center md:text-left">
