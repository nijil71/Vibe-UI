    ...
    return (
        <div className="w-full max-w-7xl mx-auto py-16 md:py-24 px-6">
            <div className="text-center mb-12 md:mb-16">
                ...
                <p className="text-neutral-400 text-base md:text-lg max-w-2xl mx-auto">Our infrastructure is designed to scale with your ambitions, providing the performance and security your users expect.</p>
            </div>
