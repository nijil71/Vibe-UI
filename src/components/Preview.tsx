...
function DynamicPreview() {
  return (
    ...
    >
      ...
      {/* Main Panel */}
      <div className="relative rounded-3xl border border-white/10 bg-[#0f0f0f] shadow-[0_60px_140px_-40px_rgba(0,0,0,0.9)] overflow-hidden p-14">
        ...
        <div className="grid grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-2">
              ...
              <div className="px-4 py-2 rounded-full border border-white/20 text-white text-sm">
                Learn More
              </div>
            </div>
          </div>
...
<div className="relative h-64 rounded-2xl border border-white/10 bg-[#111111] overflow-hidden">
  ...
  />
      ...
      <motion.div
        ...
        className="absolute -top-10 -right-10 p-6 rounded-2xl bg-[#121212] border border-white/10 shadow-xl backdrop-blur-md"
      >
        <p className="text-xs text-neutral-400 mb-1">Components</p>
      ...
      <motion.div
        ...
        className="absolute -bottom-16 left-10 p-6 rounded-2xl bg-[#121212] border border-white/10 shadow-xl"
      >
        <p className="text-xs text-neutral-400 mb-1">Layouts</p>
